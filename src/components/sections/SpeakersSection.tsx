...
const SpeakersSection = () => {
  const speakers = [
    {
      ...
      expertise: ['Tourisme Durable', 'Politiques Publiques', 'Développement International'],
      social: {
        linkedin: '#',
        twitter: '#'
      }
    },
    {
      ...
      expertise: ['Financement', 'Développement Durable', 'Partenariats Publics-Privés'],
      social: {
        linkedin: '#',
        twitter: '#'
      }
    },
    {
      ...
      expertise: ['Marketing Digital', 'E-tourisme', 'Innovation Technologique'],
      social: {
        linkedin: '#',
        twitter: '#'
      }
    },
    {
      ...
      expertise: ['Écotourisme', 'Entrepreneuriat', 'Développement Communautaire'],
      social: {
        linkedin: '#',
        twitter: '#'
      }
    ...
    },
    {
      ...
      expertise: ['Politiques Touristiques', 'Développement Régional', 'Durabilité'],
      social: {
        linkedin: '#',
        twitter: '#'
      }
  ...
  return (
    <section id="intervenants" className="py-24 bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20 relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed font-medium">
            Rencontrez les leaders qui façonnent l'avenir du tourisme durable dans l'Océan Indien et au-delà.
          </p>
        </div>
          ...
          {speakers.map((speaker, index) => (
            ...
            >
              ...
              <div className="p-8 relative z-10">
                <h3 className="text-2xl font-black text-gray-900 mb-2 group-hover:text-teal-700 transition-colors duration-300">{speaker.name}</h3>
                <p className="text-teal-600 font-bold mb-2 text-lg">{speaker.title}</p>
                <p className="text-gray-600 text-sm mb-6 font-medium">{speaker.company}</p>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-12 border-2 border-white/20 shadow-2xl max-w-4xl mx-auto">
            ...
            <p className="text-gray-200 mb-8 text-lg leading-relaxed">
              Plus de 30 intervenants confirment leur présence pour partager leur expertise 
              et échanger avec vous lors de cette conférence exceptionnelle.
            </p>
            <a
              href="#inscription"
