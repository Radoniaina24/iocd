      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-teal-100 to-blue-100 rounded-full mb-6">
            <span className="text-teal-800 font-bold text-sm">🌟 ÉVÉNEMENT EXCEPTIONNEL</span>
          </div>
          <h2 className="text-4xl md:text-6xl font-black text-gray-900 mb-6 leading-tight">
            Une Conférence <span className="bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent">d'Envergure</span>
          </h2>
          <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
            IOCDAFRICA rassemble les acteurs clés du tourisme durable pour créer un écosystème entrepreneurial robuste dans l'Océan Indien.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center text-center">
                  <div className={`w-20 h-20 bg-gradient-to-r ${stat.color} rounded-3xl flex items-center justify-center mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 shadow-lg`}>
                    <IconComponent className="w-8 h-8 text-white" />
                  </div>
                  <div className={`text-5xl font-black mb-3 bg-gradient-to-r ${stat.color} bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300`}>
                    {stat.number}
                  </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full shadow-lg">
            <span className="text-gray-900 font-bold text-lg">⚡ Places limitées - Réservez maintenant !</span>
          </div>
        </div>
      </div>
    </section>
