        ...
        <div className="py-16 grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              La conférence de référence pour le développement du tourisme durable 
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:contact@iocdafrica.com" className="text-white hover:text-teal-400 transition-colors">
                    contact@iocdafrica.com
                  </a>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="tel:+230xxxxxxx" className="text-white hover:text-teal-400 transition-colors">
                    +230 xxx xxxx
                  </a>
                </div>
              </div>
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="text-center">
            <p className="text-gray-400 text-sm mb-2">
              📅 <strong>18-19 Septembre 2024</strong> • 🏝️ <strong>Île Maurice</strong> • 🎯 <strong>500+ Participants</strong>
            </p>
            <p className="text-teal-400 text-sm font-medium">
              Transformons ensemble l'avenir du tourisme durable dans l'Océan Indien
            </p>
          </div>
        </div>
      </div>
